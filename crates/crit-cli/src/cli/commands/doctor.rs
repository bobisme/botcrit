...
use crit_core::events::EventEnvelope;
use crit_core::log::open_or_create;
use crate::output::{Formatter, OutputFormat};
use crit_core::projection::{sync_from_log_with_backup, ProjectionDb};
use crit_core::scm::{resolve_backend, BackendDetection, ScmPreference};
use crit_core::version::{detect_version, DataVersion};
